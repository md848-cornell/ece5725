...
class BTKbDevice():
    ...
    MY_ADDRESS="B8:27:EB:39:30:66"
    MY_DEV_NAME="RPi_Mouse"
    ...
    def init_bt_device(self):
        ...
        os.system("hciconfig hcio class 0x002580")
...
class  BTKbService(dbus.service.Object):
    ...
    @dbus.service.method('org.yaptb.btkbservice', in_signature='iai')
    def send_move(self,buttons,move):

        buttons = int(buttons)
        move = [int(x) for x in move]

        #print(buttons, move[0], move[1], move[2])
        ...
        for c in cmd_str: print(hex(ord(c)),end='|')
        print()
        self.device.send_string(cmd_str);

    @dbus.service.method('org.yaptb.btkbservice', in_signature='iai')
    def send_array(self, q, a):
